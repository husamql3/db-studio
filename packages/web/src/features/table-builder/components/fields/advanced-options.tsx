...
export const AdvancedOptions = ({
	...
	const isNullable = useWatch({ control, name: `fields.${index}.isNullable` });
	const isUnique = useWatch({ control, name: `fields.${index}.isUnique` });
	const isIdentity = useWatch({ control, name: `fields.${index}.isIdentity` });
	const isArray = useWatch({ control, name: `fields.${index}.isArray` });
	...
	const checkedCount = useMemo(() => {
		const field = { isNullable, isUnique, isIdentity, isArray };
