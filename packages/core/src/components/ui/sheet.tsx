	...
	return (
		<SheetPortal>
			...
			<SheetPrimitive.Content
				...
				className={cn(
					"bg-black data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col border-zinc-800 shadow-2xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-300",
					side === "right" &&
...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn("flex flex-col gap-1.5 p-4 border-b border-zinc-800", className)}
			{...props}
		/>
	);
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn(
				"mt-auto flex flex-row justify-end gap-2 p-4 border-t border-zinc-800",
				className,
			)}
			{...props}
		/>
